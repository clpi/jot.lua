...
local lib, log, mod, utils = dorm.lib, dorm.log, dorm.mod, dorm.utils

local module = mod.create("calendar.views.monthly")
...
module.private = {
    namespaces = {
        logical = vim.api.nvim_create_namespace("dorm/calendar/logical"),
        decorational = vim.api.nvim_create_namespace("dorm/calendar/decorational"),
    },
    ...
    new_view_instance = function()
        return {
            ...
            render_month_banner = function(self, ui_info, date, weekday_banner_extmark_id)
                ...
                self.extmarks.decorational.month_headings[weekday_banner_extmark_id] = module.private
    ...
    display_help = function(lines)
        ...
        local namespace = vim.api.nvim_create_namespace("dorm/calendar-help")
...
---@class base.calendar.views.monthly
module.public = {
            ...
            vim.keymap.set("n", "i", function()
                ...
                vim.keymap.set(
                    ...
                    lib.wrap(module.private.display_help, {
                        ...
                        {},
                        {
                            { "Tuesday May 5th 2023 19:00.23", "@dorm.markup.verbatim" },
                        },
                        {
                            { "10 Feb CEST 0600", "@dorm.markup.verbatim" },
                            { " (",               "@comment" },
                            { "0600",             "@text.emphasis" },
                            { " is the year)",    "@comment" },
                        },
                        {
                            { "9:00.4 2nd March Wed", "@dorm.markup.verbatim" },
                        },
                    }),
                    { buffer = buffer }
                )
                ...
                vim.keymap.set({ "n", "i" }, "<CR>", function()
                    ...
                    local parsed_date = module.required["time"].parse_date(line)
                    ...
                    local lua_date = module.required["time"].to_lua_date(parsed_date)
...
module.load = function()
    module.required["calendar"].add_view(module.public.view_name, module.public)
end
