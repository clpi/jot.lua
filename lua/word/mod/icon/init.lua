...
module.config.public = {
  ...
  icons = {
    ...
    quote = {
      ...
      highlights = {
        "@word.quotes.1.prefix",
        "@word.quotes.2.prefix",
        "@word.quotes.3.prefix",
        "@word.quotes.4.prefix",
    ...
    heading = {
      icons = { "◉", "◎", "○", "✺", "▶", "⤷" },
      highlights = {
        "@word.headings.1.prefix",
        "@word.headings.2.prefix",
        "@word.headings.3.prefix",
        "@word.headings.4.prefix",
        "@word.headings.5.prefix",
        "@word.headings.6.prefix",
      },
      nodes = {
        "heading1_prefix",
        "heading2_prefix",
    ...
    footnote = {
      single = {
        ...
        title_highlight = "@word.footnotes.title",
...
local function get_parsed_query_lazy()
  ...
  module.private.prettify_query = utils.ts_parse_query("word", query_combined)
...
local function handle_init_event(event)
  ...
  local language_tree = vim.treesitter.get_parser(event.buffer, "word")
