...
module.load = function()
  vim.keymap.set("", "<Plug>(word.time.insert-date)", lib.wrap(module.public.insert_date, false))
  vim.keymap.set("i", "<Plug>(word.time.insert-date.insert-mode)", lib.wrap(module.public.insert_date, true))
end
