...
local init = mod.create("calendar")
...
init.public = {
    ...
    create_calendar = function(buffer, window, options)
        ...
        local view = init.private.get_view(options.view or "monthly")
    ...
    open = function(options)
        ...
        return init.public.create_calendar(buffer, window, options)
    end,
...
init.load = function()
    ...
    init.public.add_mode("standalone", function(_)
        return {}
    end)

    init.public.add_mode("select_date", function(callback)
        return {
    ...
    init.public.add_mode("select_range", function(callback)
        return {
            range_start = nil,
            range_end = nil,
