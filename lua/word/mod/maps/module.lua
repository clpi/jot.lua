--[[
    ...
    summary: Module for managing keybindings with word mode support.
    ---
    ...
    if module.config.public.base_keys then
        ...
        vim.api.nvim_create_autocmd("FileType", {
            ...
            callback = function(ev)
                module.public.set_keys_for(ev.buf, preset.word)
            end,
        })
    end
end
...
module.public = {
    ...
    extend_preset = function(name, preset)
        ...
        module.public.bind_word_keys(vim.api.nvim_get_current_buf())
    end,
