...
The TOC module exposes a single command - `:word toc`. This command can be executed with one of three
...
local word = require("word.core")
local modules, utils, log = word.modules, word.utils, word.log
...
module.load = function()
  modules.await("core.wordcmd", function(wordcmd)
