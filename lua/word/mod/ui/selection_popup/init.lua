--[[
    A UI init to allow the user to press different keys to select different actions
--]]
...
local init = mod.create("ui.selection_popup")

---@class base.ui.selection_popup
init.public = {
                ...
                local configuration = vim.tbl_deep_extend(
                    "force",
                    {
                        ...
                        hl = {
                            ...
                            key = "@word.selection_window.key",
                            description = "@word.selection_window.keyname",
                            delimiter = "@word.selection_window.arrow",
                        },
                        delimiter = " -> ",
