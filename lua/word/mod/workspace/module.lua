--[[
    ...
    summary: This module is be responsible for managing directories full of .word files.
    ---
...
```lua
local workspace = require('word').mod.get_module("workspace")
...
module.load = function()
  ...
  vim.keymap.set("", "<Plug>(word.workspace.new-note)", module.public.new_note)
...
module.public = {
  ...
  new_note = function()
    if module.config.public.use_popup then
      module.required["ui"].create_prompt("wordNewNote", "New Note: ", function(text)
