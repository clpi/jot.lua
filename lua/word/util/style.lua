---@class word.util.style
local M = {}

---@alias word.util.style.hl table<string, string|vim.api.keyset.highlight>

local hl_groups = {} ---@type table<string, vim.api.keyset.highlight>
vim.api.nvim_create_autocmd("ColorScheme", {
  group = vim.api.nvim_create_augroup("word_hl", { clear = true }),
  callback = function()
...
---@param groups word.util.style.hl
