...
--- Initializes jot. Parses the supplied user config, initializes all selected mod and adds filetype checking for `.jot`.
--- @param conf jot.config.user? A table that reflects the structure of `config.user`.
--- @see config.user
--- @see jot.config.user
