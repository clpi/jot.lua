---@class jot.util.style
local M = {}

---@alias jot.util.style.hl table<string, string|vim.api.keyset.highlight>

local hl_groups = {} ---@type table<string, vim.api.keyset.highlight>
vim.api.nvim_create_autocmd("ColorScheme", {
  group = vim.api.nvim_create_augroup("jot_hl", { clear = true }),
  callback = function()
...
---@param groups jot.util.style.hl
