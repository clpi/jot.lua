--[[
    ...
    summary: Provide an LSP Completion source for jot
    internal: true
    ---
...
jot completions the same way you get completions from other language servers.
--]]
...
M.config.public = {
  ...
  -- The identifier for the jot source.
  name = "[wd]",
}
...
M.public = {
  ...
  complete = function(context, prev, saved)
    ...
    local completions = prev or M.public.completions
...
---@class lsp.completion : jot.completion_engine
M.public = {
