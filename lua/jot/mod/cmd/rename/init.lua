--[[
    file: cmd-rename
    title: Provides the `:jot rename` Command
    summary: rename to last location before entering jot.
    internal: true
    ---
When executed (`:jot rename`), all currently open `.jot` files are deleted from
