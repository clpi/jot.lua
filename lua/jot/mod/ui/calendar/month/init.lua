...
local init = mod.create("ui.calendar.month")
...
init.public.data = {
  ...
  display_help = function(lines)
    ...
    local namespace = vim.api.nvim_create_namespace("jot/calendar-help")
      ...
      vim.keymap.set("n", "i", function()
        ...
        vim.keymap.set(
          ...
          lib.wrap(init.public.data.display_help, {
            ...
            {},
            {
              { "Tuesday May 5th 2023 19:00.23", "@jot.markup.verbatim" },
            },
            {
              { "10 Feb CEST 0600", "@jot.markup.verbatim" },
              { " (",               "@comment" },
              { "0600",             "@text.emphasis" },
              { " is the year)",    "@comment" },
            },
            {
              { "9:00.4 2nd March Wed", "@jot.markup.verbatim" },
            },
          }),
          { buffer = buffer }
        )
        ...
        vim.keymap.set({ "n", "i" }, "<CR>", function()
          ...
          local parsed_date = init.required["time"].parse_date(line)
          ...
          local lua_date = init.required["time"].to_lua_date(parsed_date)
...
init.load = function()
  init.required["ui.calendar"].add_view(init.public.view_name, init.public)
end
