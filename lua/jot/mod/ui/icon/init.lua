--[[
    ...
    summary: Enhances the basic jot experience by using icons instead of text.
    embed: https://user-images.githubusercontent.com/76052559/216767027-726b451d-6da1-4d09-8fa4-d08ec4f93f54.png
    ---
"Concealing" is the process of hiding away from plain sight. When writing raw jot, long strings like
`***** Hello` or `$$ Definition` can be distracting and sometimes unpleasant when sifting through large notes.

To reduce the amount of cognitive load required to "parse" jot documents with your own eyes, this module
...
local log, mod, utils = jot.log, jot.mod, jot.utils
...
module.config.public = {
  ...
  -- If true, jot will enable folding by default for `.jot` documents.
  ...
  --
  -- Set to `false` if you do not want jot setting anything.
  folds = true,

  -- When set to `auto`, jot will open all folds when opening new documents if `foldlevel` is 0.
  -- When set to `always`, jot will always open all folds when opening new documents.
  -- When set to `never`, jot will not do anything.
  mod_open_folds = "auto",
  ...
  icons = {
    ...
    heading = {
      icons = { "◉", "◎", "○", "✺", "▶", "⤷" },
      highlights = {
        "@jot.headings.1.prefix",
        "@jot.headings.2.prefix",
        "@jot.headings.3.prefix",
        "@jot.headings.4.prefix",
        "@jot.headings.5.prefix",
        "@jot.headings.6.prefix",
      },
      nodes = {
        -- "heading1_prefix",
        -- "heading2_prefix",
    ...
    code_block = {
      ...
      highlight = "@jot.tags.ranged_verbatim.code_block",
