...
init.public = {
  ...
  ---@param  name string the name of the buffer contained within the split (will have jot:// prepended to it)
  ...
  --- Creates a new jot buffer in a split or in the main window
  ---@param name string the name of the buffer *without* the .jot extension
  ---@param split_type string "vsplitl"|"vsplitr"|"split"|"nosplit" - if suffixed with "l" vertical split will be spawned on the left, else on the right. "split" is a horizontal split.
  ---@param config table|nil a table of { option = value } pairs that set buffer-local options for the created jot buffer
