...
local lib, mod, utils, log = jot.lib, jot.mod, jot.utils, jot.log
...
M.config.public = {
  ...
  -- code all code blocks in the current jot file on file write.
  code_on_write = false,

  -- When text in a code block is less indented than the block itself, jot will not code that
